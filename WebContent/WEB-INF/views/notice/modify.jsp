...
function goList() {
	location.href="detail.action?no=${notice.no}";
}
</script>
<style type="text/css">
body{
	...
	<div class="row">
			<div class="col-md-12">
				<div class="jumbotron" style="vertical-align: center;">
					<form action="modify.action" method="POST" name="board" onsubmit="return checkValue()">
					<input type="hidden" name="no" value="${notice.no}">
						<h3 style="text-align: center;">공지 작성</h3>
						<table>
							<tr>
								<th style="width:10%">제목</th>
								<td><input type="text" maxlength="40" id="title" name="title" style="width:100%" value="${notice.title}"></td>
							</tr>
							<tr>
								<th style="width:10%">내용</th>
								<td><textarea maxlength="2040" id="content" name="content" style="width:100%; resize: none" rows="20" >${notice.content}</textarea></td>
							</tr>
						</table>
