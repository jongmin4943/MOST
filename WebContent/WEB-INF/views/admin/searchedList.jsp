...
<div style="float: right; margin: 10px 25px;">
	<form action="searchedList.action" method="GET">
		<input type="search" id="keyword" name="keyword" placeholder="아이디 검색" maxlength="30" /> 
		<input class="btn btn-primary btn-sm" type="submit" value="찾기" />
	</form>
</div>
